  ...
  return (
    <div className="min-h-screen bg-bg">
      ...
      <main className="mx-auto max-w-2xl px-5 py-8">
        <Link to="/berita" className="mb-4 inline-flex items-center gap-1 text-xs font-semibold text-textSoft">
        ...
        {!loaded ? null : !post ? (
          ...
          <>
            <article>
              ...
              <h1 className="mt-2 font-display text-2xl font-bold leading-tight text-cream sm:text-3xl">{post.title}</h1>
            ...
            {related.length > 0 && (
              <div className="mt-10 border-t-2 border-cream pt-4">
                <h2 className="font-display text-sm font-bold uppercase tracking-wide text-cream">Kegiatan Lainnya</h2>
